...
import 'package:friday/services/open_ai_service.dart';
import 'package:friday/widgets/feature_box.dart';
        ...
        child: FloatingActionButton(
          ...
          onPressed: () async {
            if (await speechToText.hasPermission && speechToText.isNotListening) {
              ...
              if (lastWords.trim().isEmpty) return;

              final speech =
              await openAIService.isArtPromptAPI(lastWords);

              if (speech.startsWith('http')) {
